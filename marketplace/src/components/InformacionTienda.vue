<template>
  <div>
    <b-card
      ...
      v-bind:sub-title="tienda.descripcion"
    >
      <div class="info">
        <b-card-text>
        ...
        <b-card-text>
          <h4>
            Direción: {{ tienda.pais }},{{ tienda.provincia }},{{
              tienda.canton
            }}
          </h4>
        </b-card-text>
      ...
      <b-card-text>
        <div v-if="comp > 0">
          ...
          <b-button
            variant="danger"
            v-if="reportesR == 1"
            @click="elimanarReporte()"
            >Eliminar Reporte</b-button
          >
        </div>
      </b-card-text>
    </b-card>
...
export default {
  ...
  methods: {
    ...
    handleOk(bvModalEvt) {
      ...
      axios
        .post(
          process.env.VUE_APP_API_URL + "agregar_reporte",
    ...
    cambiar() {
      if (this.status == "accepted") {
        ...
        axios
          .post(
            process.env.VUE_APP_API_URL + "agregar_suscripcion",
