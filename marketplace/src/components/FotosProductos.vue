          ...
          <b-row class="actions">
            ...
            <b-row>
              ...
              <b-col md="4">
                ...
                <b-button v-b-modal.modal-prevent-closingo variant="primary"
                  >Agregar a carrito</b-button
                >
                <b-modal
                  id="modal-prevent-closingo"
                  ref="modal"
              ...
              <br />
              <b-col md="3">
                <b-button variant="primary" @click="irCompra()"
            ...
            <div class="cuerpo-comentario">
              ...
              <div v-if="comentario.respuesta == null" class="btn-responder">
                <button
                  ...
                  v-if="comentario.comprador == comprador_id"
                
                  @click="eliminarComentario(comentario.comentario_id)"
                >
                  Eliminar
                </button>
              </div>
      ...
      >
        <form ref="form" @submit.stop.prevent="handleSubmit">
          <b-form-group
            ...
            invalid-feedback="El comentario es requerido"
            :state="nameState"
          >
            <b-form-textarea
              id="idMensaje"
